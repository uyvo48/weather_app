...
class HomeController {
  List<HomeModel> listWeatherForCast = [
    ...
    HomeModel(0xffFAE3E3, iconWind, 'Wind', AppRouter.uvIndexScreen),
    HomeModel(0xffE7E8EC, iconSnowFall, 'Snow\nFal ', AppRouter.uvIndexScreen),
    HomeModel(0xffF9F0E3, iconCompass, 'Compass', AppRouter.uvIndexScreen),
    HomeModel(
      0xffD3F9F9,
      iconPrecipitation,
      'Precipitation',
    ...
    HomeModel(0xffFAD4F8, iconSunTime, 'Sun\nTime', AppRouter.uvIndexScreen),
    HomeModel(0xffD4DAFA, iconPollen, 'Pollen', AppRouter.uvIndexScreen),
    HomeModel(0xffF9FFD8, iconWave, 'Wave', AppRouter.uvIndexScreen),
  ];
